...
<html>
<head>
	<title>Jojo - Form Designer</title>
...
<body>
	<a class='logout hide' href='login.php?logout=true'>logout</a>

	<div class="ffcover_add">


		<div id="title_div" class="hide">	
			<h1>Jojo - Form Designer</h1>
		</div>
		...
		<form class="modal hide fade" id='new_form' action='javascript:submit_new_form();' style='width: 640px'>
			...
			<div style="width:800px;margin : 40px auto;">Copyright © 2009 - <?php echo date('Y'); ?> Jojo Studio ( <a href="https://jauharimalik.github.io" target="_blank"> Jojo Studio </a> ) All Right Reserved.</div>
									</div>
